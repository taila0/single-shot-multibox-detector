...
def simple_detection_netowrk(input_shape, n_anchors, n_classes):
    ...
    conv2_2 = Conv2D(num_features*2, kernel_size=(3, 3), strides=(2, 2), padding='same', activation='relu', name='conv2_2')(norm2_1)
    ...
    conv3_2 = Conv2D(num_features*4, kernel_size=(3, 3), strides=(2, 2), padding='same', activation='relu', name='conv3_2')(norm3_1)
    ...
    conv4_2 = Conv2D(num_features*8, kernel_size=(3, 3), strides=(2, 2), padding='same', activation='relu', name='conv4_2')(norm4_1)
    ...
    conv5_2 = Conv2D(num_features*8, kernel_size=(3, 3), strides=(2, 2), padding='same', activation='relu', name='conv5_2')(norm5_1)
